...
if punch_in_done and punch_out_done:
    st.success("✅ You have already submitted both actions today.")
    st.stop()

with st.form("attendance_form"):
    action = st.radio("Choose Action", ["Punch In", "Punch Out"], disabled=(punch_in_done if "Punch In" else punch_out_done))
